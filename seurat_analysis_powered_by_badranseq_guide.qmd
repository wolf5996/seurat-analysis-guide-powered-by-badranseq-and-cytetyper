...
The fully annotated Seurat object — with manual labels, CyteTypeR predictions, and all reductions intact — is saved as a compressed RDS for downstream use.
...
write_rds(pbmc_annotated, "../checkpoints/pbmc3k_final.rds", compress = "gz")
```
